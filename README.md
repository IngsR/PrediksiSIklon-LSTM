...
Disarankan untuk menggunakan _virtual environment_ agar tidak terjadi konflik pustaka.
...
4.  **Post-processing**: Hasil prediksi dikembalikan ke skala aslinya (_inverse transform_).
...
- **Model**: Model yang digunakan adalah LSTM dengan _window size_ 8, yang berarti membutuhkan minimal 8 data observasi sebelumnya untuk menghasilkan prediksi yang optimal.
...
**Ikhwan Ramadhan**
_Program ini dikembangkan untuk keperluan Kelengkapan Skripsi._

---

_© 2026 - Sistem Prediksi Siklon Tropis_
