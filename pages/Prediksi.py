...
st.markdown(
    "<div class='page-section-header'><div><h2 class='section-title'>Prediksi Lintasan Siklon (LSTM)</h2>"
    "<p class='section-subtitle'>Input titik observasi secara interaktif dan jalankan prediksi lintasan siklon untuk horizon 3-9 jam dengan visualisasi real-time.</p></div></div>",
...
with left_col:
    ...
    st.markdown(
        ...
        "<div><h2 class='section-title'>📝 Editor Observasi</h2>"
        "<p class='section-subtitle'>Masukkan dan sunting titik observasi secara terstruktur, atur waktu awal, lalu hitung prediksi lintasan siklon berbasis LSTM.</p></div>"
        "</div>",
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        "<div class='page-notice'>Klik titik pada peta untuk menambahkan koordinat ke data observasi. Pastikan semua titik LAT dan LON terisi sebelum prediksi.</div>",
        unsafe_allow_html=True,
    )

    btn_col_print, btn_col_pred, btn_col_reset = st.columns([1, 1, 1], gap="small")
    with btn_col_print:
...
with right_col:
    st.markdown("<div class='page-panel map-panel'>", unsafe_allow_html=True)
    st.markdown(
        "<div class='page-section-header'>"
        "<div><h2 class='section-title'>🗺️ Visualisasi Jalur</h2>"
        "<p class='section-subtitle'>Lihat posisi observasi saat ini dan prediksi lintasan nanti secara visual pada peta interaktif.</p></div>"
        "</div>",
        unsafe_allow_html=True,
    )
    ...
    if st.session_state.prediction_result:
        ...
        st.markdown(
            "<div class='page-section-header'>"
            "<div><h2 class='section-title'>📍 Hasil Prediksi</h2>"
            "<p class='section-subtitle'>Ringkasan hasil prediksi setiap langkah waktu, lengkap dengan metrik kecepatan dan kategori pergerakan.</p></div>"
            "</div>",
            unsafe_allow_html=True,
        )
